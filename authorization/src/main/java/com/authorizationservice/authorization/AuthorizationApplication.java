...
public class AuthorizationApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception{
		AuthenticationRequest user1 = new AuthenticationRequest("user1","user123");
		AuthenticationRequest user2 = new AuthenticationRequest("user2","user123");
		AuthenticationRequest user3 = new AuthenticationRequest("user3","user123");
		AuthenticationRequest user4 = new AuthenticationRequest("user4","user123");
